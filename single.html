...
<body class="l-grid">
    ...
    <main class="l-grid-main">
        ...
        <div class="p-mainvisual__image--single">
            ...
            <img src="./img/single.png" alt="メインビジュアル">
        ...
        <article class="p-article">
            <div class="c-inner__single">
                ...
                <div>
                    <img src="./img/single-1.png" alt="" class="c-image__common">
                </div>
                <section class="c-recommend__menu">
                    <img src="./img/single-1.png" alt="">
                ...
                <div class="c-image__main"><img src="./img/single-1.png" alt=""></div>
                <section class="l-grid__image">
                    <div class="c-image__sub"><img src="./img/single-1.png" alt=""></div>
                    <div class="c-image__sub"><img src="./img/single-1.png" alt=""></div>
                    <div class="c-image__sub"><img src="./img/single-1.png" alt=""></div>
                    <div class="c-image__sub"><img src="./img/single-1.png" alt=""></div>
                    <div class="c-image__sub"><img src="./img/single-1.png" alt=""></div>
